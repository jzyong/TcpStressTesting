...
type Player struct {
	...
	social           *Social                            //社交数据、好友
	BetGold          int64                              //下注金币
}

// 玩家社交
func (p *Player) GetSocial() *Social {
	if p.social == nil {
		p.social = NewSocial(p.Id)
	}
	return p.social
}
